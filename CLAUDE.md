...
- Autonomie mobile complète (usage sans Mac) : génération de code de synchro ✅ et onglet Clients ✅ faits côté mobile. Reste "Mon entreprise" (nom, adresse, SIRET, TVA, RIB, logo) éditable depuis Réglages mobile — sans ça une facture créée depuis un téléphone jamais pairé à un Mac n'a pas d'en-tête valide.
